...
_Generated by `bin/timeline`. Re-run after new commits land; any commit_
_matching no rule is listed under "Classification notes" as unclassified._
...
| Phase | Scope | Dates | Commits | Active h | Churn (+/−) | AI % | Notes |
|-------|-------|-------|--------:|---------:|-------------|-----:|-------|
| Phase 0 — Initial implementation | Cursor-era predicates, decision logic, first YAML, FERPA/FTI work | 2025-08-26 → 2025-09-14 | 14 | 4.30 | +2708 / −1286 | 0% | Pre-gem; no AI co-author trailers in this era |
| Docs / writeup | README, ROADMAP, AGENTS.md, transition/box plans, about outline, time-spent | 2025-09-13 → 2026-06-16 | 23 | 1.91 | +278 / −8 | 65% | Spans the whole project; overlaps every other phase |
| Correctness fixes | Box 4/5/7/8/9 transitions + Box 9 PII inversion; YAML↔PDF alignment | 2026-02-21 → 2026-05-22 | 5 | 0.68 | +503 / −342 | 100% | Thematic; deliberately spread across the calendar (overlaps several phases) |
| Phase 1 — Gem packaging | Restructure the flat project into a Ruby gem | 2026-02-21 | 2 | 0.45 | +432 / −459 | 100% | Includes .claude/ gitignore + Gemfile.lock housekeeping |
| Phase 1.5 — Rule engine / verification | RuleEngine, Trace audit trail, exhaustive 36,864-combo verification, scenario library | 2026-02-22 | 4 | 0.41 | +1108 / −42 | 100% | Single-day burst |
| Phase 2 — Interactive CLI | walkthrough, quiz, evaluate modes | 2026-02-22 | 3 | 1.01 | +1573 / −8 | 100% | Largest additive churn relative to commit count |
...
Totals row as the repo-wide floor.

Regenerate with `bin/timeline` (or `make timeline`). The classification
ruleset, override table, and per-commit notes live in the tool.
...
Moved to [docs/time-spent.md](docs/time-spent.md).
