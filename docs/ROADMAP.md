...
- **Fix Box 8 No transition** *(needs discussion)*: Box 8 No currently falls through to Box 9 in the implementation; PDF tracing suggests Box 8 No may terminate at the gray "Disclosure Not Permitted (Review ...)" node. Detailed plan: [nasfaa-box-8-transition.md](nasfaa-box-8-transition.md)
